...
app.controller('coverController',function($scope,Facebook,$timeout,$interval){
    ...
    $scope.result = {
        ...
        creatorText:"ชื่อผู้สร้างแบนเนอร์",
        creatorLink:"http://ผู้สร้าง",
        msg:""
    };
    ...
    $scope.redraw = function(index){
        ...
        ctx.textAlign = 'right';
        ctx.fillText($scope.result.creatorText,coverSize.x-5,coverSize.y-15);
        ctx.fillText($scope.result.creatorLink,coverSize.x-5,coverSize.y-5);
